...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/iclab/FIRA_ws/src/particle_filter)
  set(localization_DEVEL_PREFIX /home/iclab/FIRA_ws/src/qtcreator-build/devel)
...
if(NOT "/home/iclab/FIRA_ws/src/qtcreator-build/devel/include;/home/iclab/FIRA_ws/src/particle_filter/include" STREQUAL "")
  set(localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/iclab/FIRA_ws/src/qtcreator-build/devel/include;/home/iclab/FIRA_ws/src/particle_filter/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'iclab <iclab@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iclab/FIRA_ws/src/particle_filter/${idir}'.  Ask the maintainer 'iclab <iclab@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iclab/FIRA_ws/src/qtcreator-build/devel/lib;/home/iclab/FIRA_ws/devel/lib;/home/iclab/catkin_ws/devel/lib;/opt/ros/hydro/lib)
...
set(depends "roscpp;std_msgs;message_runtime;cv_bridge")
